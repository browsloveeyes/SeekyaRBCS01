...
namespace Seekya
{
    ...
    {
        //直接打印
        public void ReportPrintDirect(string name, string gender, string age, string id, string instrumentType, string submitDoctor, string firstVisit, string hb, string hospital, string rbc, string co, string co2, string testDateLine, string department, string userDefine1, string userDefine2, string userDefine3, string userDefine4, string userDefine5, string userDefine6, string checkDoctor, string reportDoctor, string reportTime, string remark1, string remark2,string tyn)
        {
            WriteCopyTemplate(name, gender, age, id, instrumentType, submitDoctor, firstVisit, hb, hospital, rbc, co, co2, testDateLine, department, userDefine1, userDefine2, userDefine3, userDefine4, userDefine5, userDefine6, checkDoctor, reportDoctor, reportTime, remark1, remark2,tyn);
            //直接打印
            //Process.Start(System.AppDomain.CurrentDomain.BaseDirectory + "Data\\template\\template.xls");

        }
        //手动打印
        public void ReportPrintHand(string name, string gender, string age, string id, string instrumentType, string submitDoctor, string firstVisit, string hb, string hospital, string rbc, string co, string co2, string testDateLine, string department, string userDefine1, string userDefine2, string userDefine3, string userDefine4, string userDefine5, string userDefine6, string checkDoctor, string reportDoctor, string reportTime, string remark1, string remark2,string tyn)
        {
            WriteCopyTemplate(name, gender, age, id, instrumentType, submitDoctor, firstVisit, hb, hospital, rbc, co, co2, testDateLine, department, userDefine1, userDefine2, userDefine3, userDefine4, userDefine5, userDefine6, checkDoctor, reportDoctor, reportTime, remark1, remark2,tyn);
            //间接打印
            //Process.Start(System.AppDomain.CurrentDomain.BaseDirectory + "Data\\template\\template.xls");
